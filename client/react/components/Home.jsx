      ...
      <div className="App">
        ...
        <div>
          <ul className="list-group">
            ...
            <li className="list-group-item">If your final score is above 750 you earn a spot on our Leader Board for a chance to win some sort of prize!</li>
          </ul>
        </div>
          <Link type="button" className="btn btn-danger" to="/game">join table!</Link>
      </div>
